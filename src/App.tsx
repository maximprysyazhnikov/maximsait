...
const COMMERCIAL_SITE_URL = "https://www.vidfranko.com.ua/";
...
const copy = {
  uk: {
    ...
    contact: { title: "Контакти", subtitle: "Відкритий до нових проєктів, співпраці та професійних можливостей.", linkedin: "LinkedIn", github: "GitHub", footer: "Designed and built with care by Maksym Prysiazhnikov." },
  ...
  en: {
    ...
    contact: { title: "Let's Connect", subtitle: "I am always open to discussing new projects, collaboration, and career opportunities.", linkedin: "LinkedIn", github: "GitHub", footer: "Designed and built with care by Maksym Prysiazhnikov." },
