...
import {
  ...
  ExternalLink, Github, Globe, Linkedin, Mail, MapPin, MessageCircle, Send, ShieldCheck,
  Terminal, X,
} from "lucide-react";
...
const copy = {
  uk: {
    ...
    hero: { badge: "Відкритий до нових можливостей", role: "Junior DevOps Engineer & Cloud Specialist, зосереджений на побудові стійкої та автоматизованої інфраструктури.", contact: "Зв'язатися", github: "GitHub" },
  ...
  en: {
    ...
    hero: { badge: "Available for opportunities", role: "Junior DevOps Engineer & Cloud Specialist focused on building resilient, automated infrastructure.", contact: "Get in touch", github: "GitHub" },
