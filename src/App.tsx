                  ...
                  <div className="rounded-2xl border border-[#51aaca]/20 bg-[#061a26]/92 p-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <div className="grid gap-2 sm:grid-cols-2">
                        ...
                        <input value={leadForm.phone} onChange={(event) => updateLeadForm("phone", event.target.value)} placeholder={t.leadPhone} inputMode="tel" pattern="\\+?[0-9]*" className="rounded-xl border border-cyan-950/70 bg-[#04141f] px-3 py-2 text-sm text-white outline-none transition placeholder:text-zinc-500 focus:border-[#51aaca]/50" />
                      </div>
